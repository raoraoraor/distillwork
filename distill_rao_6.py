...
def train_one_epoch(net,MODEL,criterion,optimizer,bnm_scheduler,TRAIN_DATALOADER,teacher_model=None,teacher_MODEL=None,teacher_TRAIN_DATALOADER=None,adapter_net=None):
    ...
    for batch_idx, batch_data_label in enumerate(teacher_TRAIN_DATALOADER):
        ...
        adapter_loss = torch.tensor(0.0).cuda()   #尚未想好如何更改
        # ------- adapter -------
...
def train_or_evaluate(start_epoch,net,MODEL,net_no_ddp,criterion,optimizer,bnm_scheduler,train_sampler,TRAIN_DATALOADER,TEST_DATALOADER, teacher_model=None,teacher_MODEL=None,teacher_TRAIN_DATALOADER=None,adapter_net=None):
    global EPOCH_CNT 
    loss = 0
...
def main_dist(local_rank, FLAGS):
    ...
    train_or_evaluate(start_epoch,
                      ...
                      teacher_model,
                      teacher_MODEL,
                      teacher_TRAIN_DATALOADER, #dataloader这里暂且先这么写着吧
